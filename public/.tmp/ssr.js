...
var intro = [
	...
	{
		type: "text",
		value: "Unusually, I have a written record of where the idea for this one came from. Our book club was very annoyed with overwrought descriptions of a fairy in Patrick Rothfuss’ The Name of the Wind. My friend <a href=https://twitter.com/lianabnana/>Liana</a> had the idea to analyze how exactly he describes her body:"
	},
	{
		type: "text",
...
const css = {
	code: "@font-face{font-family:'Lyon Display Web';src:url('./../assets/fonts/lyon/LyonDisplay-Regular-Web.woff2') format('woff2'),\n   url('./../assets/fonts/lyon/LyonDisplay-Regular-Web.woff') format('woff');font-weight:300;font-style:normal;font-stretch:normal;font-display:swap}@font-face{font-family:'Lyon Text Web';src:url('./../assets/fonts/lyon/LyonText-Regular-Web.woff2') format('woff2'),\n\turl('./../assets/fonts/lyon/LyonText-Regular-Web.woff') format('woff');font-weight:300;font-style:normal;font-stretch:normal;font-display:swap}h3.svelte-aonykc.svelte-aonykc,h1.svelte-aonykc.svelte-aonykc{font-family:'Lyon Text Web';text-align:center}h3.svelte-aonykc.svelte-aonykc{margin-bottom:1rem;text-transform:uppercase;letter-spacing:2px;color:#bd3b32;font-size:1.5rem;margin-top:4rem}h1.svelte-aonykc.svelte-aonykc{font-family:'Walter Turncoat';margin:0 auto;max-width:50rem;font-size:4rem;line-height:1.2;margin-bottom:2rem;color:rgba(0,0,0,.8)\n }.intro.svelte-aonykc.svelte-aonykc{max-width:500px;margin:0 auto}p.svelte-aonykc.svelte-aonykc{color:black;font-family:'Lyon Text Web';font-size:1.3rem}.byline.svelte-aonykc p.svelte-aonykc{text-align:center;font-size:1.1rem;margin-bottom:3rem;margin-top:2rem}a.svelte-aonykc.svelte-aonykc:hover{border-bottom:1px solid black}",
	map: "{\"version\":3,\"file\":\"Intro.svelte\",\"sources\":[\"Intro.svelte\"],\"sourcesContent\":[\"<style>\\n\\n @font-face {\\n   font-family: 'Lyon Display Web';\\n   src: url('./../assets/fonts/lyon/LyonDisplay-Regular-Web.woff2') format('woff2'),\\n   url('./../assets/fonts/lyon/LyonDisplay-Regular-Web.woff') format('woff');\\n   font-weight: 300;\\n   font-style: normal;\\n   font-stretch: normal;\\n   font-display: swap;\\n }\\n\\n @font-face {\\n\\tfont-family: 'Lyon Text Web';\\n\\tsrc: url('./../assets/fonts/lyon/LyonText-Regular-Web.woff2') format('woff2'),\\n\\turl('./../assets/fonts/lyon/LyonText-Regular-Web.woff') format('woff');\\n\\tfont-weight: 300;\\n\\tfont-style: normal;\\n\\tfont-stretch: normal;\\n\\tfont-display: swap;\\n}\\n\\n h3, h1 {\\n   font-family: 'Lyon Text Web';\\n   text-align: center;\\n }\\n\\n h3 {\\n   margin-bottom: 1rem;\\n   text-transform: uppercase;\\n   letter-spacing: 2px;\\n   color: #bd3b32;\\n   font-size: 1.5rem;\\n   margin-top:4rem;\\n }\\n\\n h1 {\\n   font-family: 'Walter Turncoat';\\n   margin: 0 auto;\\n   max-width: 50rem;\\n   font-size: 4rem;\\n   line-height: 1.2;\\n   margin-bottom:2rem;\\n   color:rgba(0,0,0,.8)\\n }\\n\\n .intro {\\n   max-width: 500px;\\n   margin: 0 auto;\\n }\\n\\n p {\\n   color: black;\\n   font-family: 'Lyon Text Web';\\n   font-size:1.3rem;\\n }\\n\\n .byline p{\\n   text-align:center;\\n   font-size:1.1rem;\\n   margin-bottom:3rem;\\n   margin-top:2rem;\\n }\\n a:hover{\\n   border-bottom:1px solid black;\\n }</style>\\n\\n<script>\\n  import doc from \\\"../data/copy.json\\\"\\n</script>\\n\\n<p class=\\\"logo-wrapper\\\">A project from the <a target=\\\"_blank\\\" class=\\\"text-underline\\\" href=\\\"/\\\">The Pudding</a></p>\\n\\n<h3>{doc.hed}</h3>\\n<h1>{doc.dek}</h1>\\n<div class=\\\"byline\\\">\\n\\t<p>by <a target=\\\"_blank\\\" href=\\\"https://pudding.cool/author/erin-davis/\\\">Erin Davis</a></p>\\n</div>\\n\\n<div class=\\\"intro\\\">\\n  {#each doc.intro as intro}\\n    <p class='prose'>{@html intro.value}</p>\\n  {/each}\\n</div>\\n\"],\"names\":[],\"mappings\":\"AAEC,UAAU,AAAC,CAAC,AACV,WAAW,CAAE,kBAAkB,CAC/B,GAAG,CAAE,IAAI,sDAAsD,CAAC,CAAC,OAAO,OAAO,CAAC,CAAC;GACjF,IAAI,qDAAqD,CAAC,CAAC,OAAO,MAAM,CAAC,CACzE,WAAW,CAAE,GAAG,CAChB,UAAU,CAAE,MAAM,CAClB,YAAY,CAAE,MAAM,CACpB,YAAY,CAAE,IAAI,AACpB,CAAC,AAED,UAAU,AAAC,CAAC,AACZ,WAAW,CAAE,eAAe,CAC5B,GAAG,CAAE,IAAI,mDAAmD,CAAC,CAAC,OAAO,OAAO,CAAC,CAAC;CAC9E,IAAI,kDAAkD,CAAC,CAAC,OAAO,MAAM,CAAC,CACtE,WAAW,CAAE,GAAG,CAChB,UAAU,CAAE,MAAM,CAClB,YAAY,CAAE,MAAM,CACpB,YAAY,CAAE,IAAI,AACnB,CAAC,AAEA,8BAAE,CAAE,EAAE,4BAAC,CAAC,AACN,WAAW,CAAE,eAAe,CAC5B,UAAU,CAAE,MAAM,AACpB,CAAC,AAED,EAAE,4BAAC,CAAC,AACF,aAAa,CAAE,IAAI,CACnB,cAAc,CAAE,SAAS,CACzB,cAAc,CAAE,GAAG,CACnB,KAAK,CAAE,OAAO,CACd,SAAS,CAAE,MAAM,CACjB,WAAW,IAAI,AACjB,CAAC,AAED,EAAE,4BAAC,CAAC,AACF,WAAW,CAAE,iBAAiB,CAC9B,MAAM,CAAE,CAAC,CAAC,IAAI,CACd,SAAS,CAAE,KAAK,CAChB,SAAS,CAAE,IAAI,CACf,WAAW,CAAE,GAAG,CAChB,cAAc,IAAI,CAClB,MAAM,KAAK,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,EAAE,CAAC;CACtB,CAAC,AAED,MAAM,4BAAC,CAAC,AACN,SAAS,CAAE,KAAK,CAChB,MAAM,CAAE,CAAC,CAAC,IAAI,AAChB,CAAC,AAED,CAAC,4BAAC,CAAC,AACD,KAAK,CAAE,KAAK,CACZ,WAAW,CAAE,eAAe,CAC5B,UAAU,MAAM,AAClB,CAAC,AAED,qBAAO,CAAC,eAAC,CAAC,AACR,WAAW,MAAM,CACjB,UAAU,MAAM,CAChB,cAAc,IAAI,CAClB,WAAW,IAAI,AACjB,CAAC,AACD,6BAAC,MAAM,CAAC,AACN,cAAc,GAAG,CAAC,KAAK,CAAC,KAAK,AAC/B,CAAC\"}"
};

const Intro = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	$$result.css.add(css);

	return `<p class="${"logo-wrapper svelte-aonykc"}">A project from the <a target="${"_blank"}" class="${"text-underline svelte-aonykc"}" href="${"/"}">The Pudding</a></p>

<h3 class="${"svelte-aonykc"}">${escape(doc.hed)}</h3>
<h1 class="${"svelte-aonykc"}">${escape(doc.dek)}</h1>
<div class="${"byline svelte-aonykc"}"><p class="${"svelte-aonykc"}">by <a target="${"_blank"}" href="${"https://pudding.cool/author/erin-davis/"}" class="${"svelte-aonykc"}">Erin Davis</a></p></div>

<div class="${"intro svelte-aonykc"}">${each(doc.intro, intro => `<p class="${"prose svelte-aonykc"}">${intro.value}</p>`)}</div>`;
});
